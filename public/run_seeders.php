    ...
    <div class="container">
        ...
        try {
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo '<div class="info">ℹ️ Admin user already exists (ID: ' . $userId . '). Removing old data...</div>';
        ...
        try {
            ...
            if ($result && $result->num_rows > 0) {
                ...
                echo '<div class="info">ℹ️ Developer user already exists (ID: ' . $userId . '). Removing old data...</div>';
